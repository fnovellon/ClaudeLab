...
const TRANSLATIONS = {
  fr: {
    ...
    sessionModeBtn: "🎯 Mode Session",
    sessionConfigTitle: "Configurer une session",
    sessionCountLabel: "Nombre de personnages",
    sessionTimeLabel: "Limite de temps",
    sessionTimeNone: "Aucune",
    sessionTimeMinutes: "{n} min",
    sessionStartBtn: "Démarrer la session",
    sessionCancelBtn: "Annuler",
    sessionProgressText: "Manche {current}/{total}",
    sessionScoreText: "Score : {score}",
    sessionQuitBtn: "Abandonner la session",
    sessionContinueBtn: "Continuer →",
    sessionResultsTitle: "Session terminée",
    sessionResultsTimeout: "Temps écoulé !",
    sessionResultsFound: "{found}/{total} personnages trouvés",
    sessionResultsScore: "Score total : {score}",
    sessionShareBtn: "📋 Partager la session",
    sessionRestartBtn: "Nouvelle session",
    shareSessionTitle: "Bleachdle — Session Illimité",
    shareSessionResult: "{found}/{total} trouvés — Score : {score}",
    shareSessionInvite: "Même session que moi ({total} personnages), bats mon score : {url}",
  ...
  en: {
    ...
    sessionModeBtn: "🎯 Session Mode",
    sessionConfigTitle: "Set up a session",
    sessionCountLabel: "Number of characters",
    sessionTimeLabel: "Time limit",
    sessionTimeNone: "None",
    sessionTimeMinutes: "{n} min",
    sessionStartBtn: "Start session",
    sessionCancelBtn: "Cancel",
    sessionProgressText: "Round {current}/{total}",
    sessionScoreText: "Score: {score}",
    sessionQuitBtn: "Quit session",
    sessionContinueBtn: "Continue →",
    sessionResultsTitle: "Session complete",
    sessionResultsTimeout: "Time's up!",
    sessionResultsFound: "{found}/{total} characters found",
    sessionResultsScore: "Total score: {score}",
    sessionShareBtn: "📋 Share the session",
    sessionRestartBtn: "New session",
    shareSessionTitle: "Bleachdle — Endless Session",
    shareSessionResult: "{found}/{total} found — Score: {score}",
    shareSessionInvite: "Same session as me ({total} characters), beat my score: {url}",
  ...
  es: {
    ...
    sessionModeBtn: "🎯 Modo Sesión",
    sessionConfigTitle: "Configurar una sesión",
    sessionCountLabel: "Número de personajes",
    sessionTimeLabel: "Límite de tiempo",
    sessionTimeNone: "Ninguno",
    sessionTimeMinutes: "{n} min",
    sessionStartBtn: "Iniciar sesión",
    sessionCancelBtn: "Cancelar",
    sessionProgressText: "Ronda {current}/{total}",
    sessionScoreText: "Puntuación: {score}",
    sessionQuitBtn: "Abandonar sesión",
    sessionContinueBtn: "Continuar →",
    sessionResultsTitle: "Sesión terminada",
    sessionResultsTimeout: "¡Se acabó el tiempo!",
    sessionResultsFound: "{found}/{total} personajes encontrados",
    sessionResultsScore: "Puntuación total: {score}",
    sessionShareBtn: "📋 Compartir la sesión",
    sessionRestartBtn: "Nueva sesión",
    shareSessionTitle: "Bleachdle — Sesión Infinito",
    shareSessionResult: "{found}/{total} encontrados — Puntuación: {score}",
    shareSessionInvite: "Misma sesión que yo ({total} personajes), supera mi puntuación: {url}",
  ...
  de: {
    ...
    sessionModeBtn: "🎯 Session-Modus",
    sessionConfigTitle: "Session einrichten",
    sessionCountLabel: "Anzahl der Figuren",
    sessionTimeLabel: "Zeitlimit",
    sessionTimeNone: "Keins",
    sessionTimeMinutes: "{n} Min",
    sessionStartBtn: "Session starten",
    sessionCancelBtn: "Abbrechen",
    sessionProgressText: "Runde {current}/{total}",
    sessionScoreText: "Punkte: {score}",
    sessionQuitBtn: "Session abbrechen",
    sessionContinueBtn: "Weiter →",
    sessionResultsTitle: "Session beendet",
    sessionResultsTimeout: "Zeit abgelaufen!",
    sessionResultsFound: "{found}/{total} Figuren gefunden",
    sessionResultsScore: "Gesamtpunktzahl: {score}",
    sessionShareBtn: "📋 Session teilen",
    sessionRestartBtn: "Neue Session",
    shareSessionTitle: "Bleachdle — Endlos-Session",
    shareSessionResult: "{found}/{total} gefunden — Punkte: {score}",
    shareSessionInvite: "Gleiche Session wie ich ({total} Figuren), schlag meine Punktzahl: {url}",
